...
- The frontend world-session transcript service coordinates loading and saving the configured character history. It does not move canonical transcript ownership to Rust or turn the render cache into persistence.
