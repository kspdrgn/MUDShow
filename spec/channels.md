...
- The first implementation uses dummy test channels to exercise the bar, reveal, hide, and resize behavior.
...
- Notes and debug console remain outside the channel system for now.
